...
namespace Novacta.Shfb.LatexTools.PresentationStyles
{
    ...
    [PresentationStyleExport(
        id: "Novacta.Shfb.LatexTools.VS2010",
        title: "VS2010 + LaTeX",
        Version = AssemblyInfo.ProductVersion,
        Copyright = AssemblyInfo.Copyright,
        Description = "VS2010 with LaTeX content.")]
    public sealed class VS2010WithLatex : PresentationStyleSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VS2010WithLatex"/> class.
        /// </summary>
        public VS2010WithLatex()
        {
            ...
            this.BasePath = Path.Combine("PresentationStyles", "VS2010");
