...
namespace Novacta.Shfb.LatexTools.PresentationStyles
{
    ...
    /// </summary>
    [PresentationStyleExport(
        id: "Novacta.Shfb.LatexTools.VS2013",
        title: "VS2013 + LaTeX",
        Version = AssemblyInfo.ProductVersion,
        Copyright = AssemblyInfo.Copyright,
        Description = "VS2013 with LaTeX content.")]
    public sealed class VS2013WithLatex : PresentationStyleSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VS2013WithLatex"/> class.
        /// </summary>
        public VS2013WithLatex()
        {
            ...
            // of the sub-folder that contains the presentation style content folders.
            this.BasePath = Path.Combine("PresentationStyles", "VS2013");

            this.SupportedFormats = 
                HelpFileFormats.HtmlHelp1 | HelpFileFormats.MSHelpViewer | HelpFileFormats.Website;
            ...
            this.PlugInDependencies.Add(new PlugInDependency("Novacta.Shfb.LatexPlugIn", null));
        }
    }
}
